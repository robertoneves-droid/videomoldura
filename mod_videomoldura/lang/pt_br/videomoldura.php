...
<li><b>Personalização Visual:</b> Adapte o cabeçalho do recurso à identidade visual da sua disciplina. Você pode escolher a cor de destaque utilizando o seletor de cores visual ou digitando o código HEX exato (ex: #496637).</li>
<li><b>Títulos e Descrições:</b> Adicione o título da aula e um subtítulo (ou nome do professor) que ganharão um destaque tipográfico profissional acima do vídeo.</li>
<li><b>Integração Direta:</b> O recurso comporta-se de maneira nativa, retendo a atenção do aluno diretamente na página inicial do curso, sem a necessidade de abrir novas abas.</li>
</ul>';