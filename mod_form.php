...
class mod_videomoldura_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'subtitle', get_string('subtitle', 'mod_videomoldura'), ['size' => '64']);
        $mform->setType('subtitle', PARAM_TEXT);

        // Campo da Cor e script de injecao.
        $mform->addElement('text', 'bordercolor', get_string('bordercolor', 'mod_videomoldura'), [
            'size' => '10',
            'maxlength' => '7',
            'id' => 'id_bordercolor',
        ]);
        ...
        global $PAGE;
        $PAGE->requires->js_call_amd('mod_videomoldura/colorpicker', 'init', ['id_bordercolor']);
